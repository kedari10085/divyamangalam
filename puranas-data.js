/* ============================================================
   ...
   Includes English, Sanskrit (Devanagari), and Telugu (తెలుగు)
   ============================================================ */

const PURANAS = [
  // ==========================================
  // 1. VAISHNAVA PURANAS (సాత్త్విక పురాణాలు - 6)
  // Dedicated to Lord Vishnu • Fosters Moksha & Devotion
  // ==========================================
  {
    id: 'vishnu',
    number: 1,
    ...
    primaryDeities: ['Bhagavan Maha Vishnu', 'Sri Krishna', 'Sri Rama', 'Narasimha'],
    famousStotras: [
  ...
  },
  {
    ...
    primaryDeities: ['Bhagavan Sri Krishna', 'Maha Vishnu', 'Dashavatara'],
    famousStotras: [
  ...
  },
  {
    ...
    primaryDeities: ['Bhagavan Narayana', 'Maha Lakshmi', 'Radha-Krishna'],
    famousStotras: [
      'Narayana Kavacha',
  ...
  },
  {
    ...
    primaryDeities: ['Bhagavan Vishnu', 'Garuda Bhagavan', 'Yamaraja', 'Dhanvantari'],
    famousStotras: [
      'Garuda Kavacha',
  ...
  },
  {
    ...
    primaryDeities: ['Bhagavan Vishnu', 'Sri Rama', 'Sri Krishna', 'Devi Tulasi', 'Lord Shiva'],
    famousStotras: [
  ...
  },
  {
    ...
    primaryDeities: ['Bhagavan Varaha', 'Bhudevi (Mother Earth)', 'Sapta Matrikas'],
    famousStotras: [
      'Varaha Kavacha',
      'Bhudevi Stuti',
  ...
  // ==========================================
  // 2. SHAIVA PURANAS (తామస పురాణాలు - 6)
  // Dedicated to Lord Shiva • Fosters Renunciation & Yoga
  // ==========================================
  {
    id: 'shiva',
    number: 7,
    ...
    primaryDeities: ['Paramashiva', 'Devi Parvati / Sati', 'Kartikeya', 'Ganesha'],
    famousStotras: [
  ...
  },
  {
    ...
    primaryDeities: ['Lord Shiva (Linga & Alinga)', 'Devi Parvati', 'Rudra'],
    famousStotras: [
  ...
  },
  {
    ...
    primaryDeities: ['Lord Skanda (Kartikeya)', 'Lord Shiva', 'Sri Venkateswara', 'Sri Jagannath'],
    famousStotras: [
      'Sri Guru Gita',
  ...
  },
  {
    ...
    primaryDeities: ['Agni Deva', 'Maha Vishnu', 'Lord Shiva', 'Devi Durga', 'Surya'],
    famousStotras: [
      'Agni Gita',
  ...
  },
  {
    ...
    primaryDeities: ['Lord Kurma (Vishnu)', 'Paramashiva', 'Devi Durga'],
    famousStotras: [
  ...
  },
  {
    ...
    primaryDeities: ['Lord Matsya (Vishnu)', 'Lord Shiva', 'Devi Parvati', 'Manu'],
    famousStotras: [
      'Matsya Stotram',
  ...
  // ==========================================
  // 3. BRAHMA PURANAS (రాజసిక పురాణాలు - 6)
  // Dedicated to Lord Brahma / Creation / Cosmic Order
  // ==========================================
  {
    id: 'brahma',
    number: 13,
    ...
    primaryDeities: ['Lord Brahma', 'Surya Bhagavan', 'Lord Purushottama (Jagannath)'],
    famousStotras: [
      'Surya Ashtakam',
  ...
  },
  {
    ...
    primaryDeities: ['Lalita Tripurasundari', 'Sri Rama', 'Lord Shiva', 'Lord Brahma'],
    famousStotras: [
  ...
  },
  {
    ...
    primaryDeities: ['Sri Radha & Sri Krishna (Goloka)', 'Lord Ganesha', 'Pancha Prakritis'],
    famousStotras: [
  ...
  },
  {
    ...
    primaryDeities: ['Devi Durga / Chandi', 'Surya Bhagavan', 'Lord Brahma', 'Indra'],
    famousStotras: [
  ...
  },
  {
    ...
    primaryDeities: ['Surya Bhagavan', 'Lord Brahma', 'Lord Shiva', 'Lord Vishnu'],
    famousStotras: [
      'Aditya Kavacham',
      'Surya Sahasranama',
  ...
  },
  {
    ...
    primaryDeities: ['Bhagavan Vamana / Trivikrama', 'Lord Shiva', 'Devi Parvati'],
    famousStotras: [
